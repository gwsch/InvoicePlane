...
<head>
    ...
    <link rel="stylesheet"
          href="<?php echo base_url(); ?>assets/<?php echo get_setting('system_theme', 'rinkon'); ?>/css/templates.css">
...
<header class="clearfix">
    ...
    <div id="client">
        <div>
			<?php if ($custom_fields['client']['Company']) {
				echo '<div><font size="5">' . $custom_fields['client']['Company'] . '</font></div>';
			} ?> 
		</div>			
		<div>
    ...
    <div id="company">
        <?php if ($invoice->user_company) {
            echo '<div><font size="5">' . htmlsc($invoice->user_company) . '</font></div>';
        } ?>
		<div>
